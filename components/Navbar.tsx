...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="bg-brand-color px-16 p-1 text White md:flex justify-between text-white text-base hidden ">
        <div className="flex items-center gap-x-5">
          <div className="flex gap-x-2 items-center">
            <BiPhoneCall className="text-lg" />
            <span>+977-9863651365</span>
          </div>
          <div className="flex gap-x-2 items-center">
      ...
      <div className=" flex md:px-16 px-5 py-1 items-center sticky top-0 justify-between">
        <div className="w-1/2 flex ">
          <Link href="/">
            <img src="img/logo.png" alt="logo" className="h-[80px]" />
          </Link>
        </div>
        <div>
